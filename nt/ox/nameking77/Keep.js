/* 
脚本功能：解锁keep会员视频
⚠️⚠️⚠️使用方法：不要点击课程预览，往下滑直接点击课程阶段⚠️⚠️⚠️
脚本作者：king
软件版本：7.17.0
...
QuantumultX:
[rewrite_local]
^https://(.+).gotokeep.com(/athena/v5/people/my|/nuocha/plans) url script-response-body https://raw.githubusercontent.com/urnuts/haproxy/main/nt/ox/nameking77/Keep.js
...
Surge4 or Loon:
[Script]
http-response ^https://(.+).gotokeep.com(/athena/v5/people/my|/nuocha/plans) requires-body=1,max-size=-1,script-path=https://raw.githubusercontent.com/urnuts/haproxy/main/nt/ox/nameking77/Keep.js
